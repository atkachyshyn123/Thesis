...
def get_imagenet_subset(class_id, split, img_size=224, bs=128, num_workers=1):
    ...
    # in_path = "/content/drive/MyDrive/thesis_data/neural_pca/imagenette2"
    print(in_path)

    # imagenet = Imagenette(in_path, split=split, transform=transform, download=True)
    ...
    # in_targets = torch.tensor([imagenet[i][1] for i in range(len(imagenet))])
    print("in_targets")
